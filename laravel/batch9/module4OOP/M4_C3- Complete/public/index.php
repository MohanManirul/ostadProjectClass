...
এখন ব্যাপারটা বুঝতে হলে আগে VehicleManager ক্লাসের constructor (__construct) কেমন সেটা দেখতে হবে।
যখন কোনো ক্লাসের object বানানো হয়, তখন যদি constructor (__construct) থাকে, সেটার parameters অনুযায়ী মান (argument) দিতে হয়। 
